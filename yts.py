...
from helpers import download_file, retrieve_url  # Importar desde helpers.py
from novaprinter import prettyPrinter  # Importar desde novaprinter.py
        ...
        def handle_starttag(self, tag, attrs):
            ...
            if self.insideRow and tag == self.A:
                ...
                if link.startswith('/torrent/'):
                    ...
                    matches = re.finditer(
                        magnet_regex, torrent_page, re.MULTILINE)
    ...
    def search(self, what, cat='all'):
        ...
        while True:
            page_url = f'{self.url}/category-search/{what}/{category}/{
                page}/' if category else f'{self.url}/search/{what}/{page}/'
